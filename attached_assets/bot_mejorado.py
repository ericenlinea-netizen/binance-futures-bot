...
# ================= PAUSA REPLIT =================
# Si BOT_PAUSED=1 el bot no arranca (evita duplicados con Railway)
if os.environ.get("BOT_PAUSED") == "1":
    print("⏸️  Bot pausado en Replit — corriendo en Railway (sin duplicados).")
    sys.exit(0)
